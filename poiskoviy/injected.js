...
function injected_main(){
        ...
        let hod=(dateInterval)=>{
                ...
                if (dubleSector!==sector) {
                        dubleSector=sector;
                        dubleSectorPoint=0;
                } else if(dubleSector===sector){dubleSectorPoint++}
        ...
        let obnovit=()=>{
                ...
                let dateInterval = setInterval(()=>{
                        ...
                        if (kolKont>=limitKont&&sector!==null&&kakProhod===0) {
                                ...
                                let oblomki = [mainOkno.querySelector('#obj_left'),
                                ...
                                for (var i = 0; i < oblomki.length; i++) {
                                        ...
                                        if (nonOblom.style.display==='block'&&imgObekt==='http://img.starcombats.com/map/obj/chelnok_01.gif') {
                                        ...
                                        } else if(imgObekt!=='http://img.starcombats.com/map/obj/hunter.gif'&&imgObekt!=='http://img.starcombats.com/map/obj/dron01.gif'&&imgObekt!=='http://img.starcombats.com/map/obj/chelnok_01.gif'){
                                                nonOblom = oblomki[i]
                                                if (nonOblom.style.display==='block') {    
                                                        oblomok = nonOblom.firstChild;
                                                }     
                                ...
                                let ataka=(oblomok)=>{
                                        ...
                                        setTimeout(()=>{
                                                ...
                                                if(triggerB<=1){mainOkno.getElementById('item1').click()}
                                                setTimeout(()=>{
                                                    if (oblomok.src==='http://img.starcombats.com/map/obj/hunter.gif'||oblomok.src==='http://img.starcombats.com/map/obj/broken_cargo.gif') {
                                                        navigBtn.click()
                                                       triggerB++
                                                    }
                                                },1000)   
                                ...
                                let ataka2=(oblomok)=>{
                                        oblomok.click()
                                        setTimeout(()=>{
                                                let mainOkn = document.getElementsByName('mainWindow')[0].contentDocument;
                                                let activBtn;
                                                let activBtns = [mainOkn.getElementById('item3'),mainOkn.getElementById('item2'),mainOkn.getElementById('item1')]
                                                ...
                                                if (activBtn!==null) {activBtn.click()}
                                ...
                                if (!oblomok) {
                                      hod(dateInterval) 
                                        ...
                                        if (oblomok.src==='http://img.starcombats.com/map/obj/broken_ship.gif'){kolKont++}
                                        if (kolKont>=limitKont&&oblomok.src==='http://img.starcombats.com/map/obj/chelnok_01.gif'&&kakProhod===1) {
                                                ataka2(oblomok)
                                        } else {
                                                ataka(oblomok)}
                                }
                                ...
                                setTimeout(()=>{
                                        ...
                                        gruze.click()
                                        setTimeout(()=>{testAuto(dateInterval)},2000)
                                },2000) 
                        } else { let navigBtn = panelMenu.querySelector('.right img:last-of-type')
                                navigBtn.click()}
